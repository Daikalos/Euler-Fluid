...
public:
	...
	inline bool get_left_held() const { return currentButtonState[sf::Mouse::Button::Left] && previousButtonState[sf::Mouse::Button::Left]; }
	inline bool get_right_held() const { return currentButtonState[sf::Mouse::Button::Right] && previousButtonState[sf::Mouse::Button::Right]; }
	inline bool get_middle_held() const { return currentButtonState[sf::Mouse::Button::Middle] && previousButtonState[sf::Mouse::Button::Middle]; }
